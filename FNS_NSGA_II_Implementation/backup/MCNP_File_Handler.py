...
class mcnp_file_handler():
    ...
    def write_mcnp_input(self, template_file_str, dictionary_of_replacements, input_file_str, options):
    ...
    def get_keff(self, output_file_string):
        ...
        try:
            ...
            print("Unable to find a keff for input " + output_file_string, "returning 10.0 and continuing")
            return 10.0
